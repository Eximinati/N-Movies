...
export const meta = mergeMeta(() => [
  { title: 'Nmovies - Popular People' },
  { name: 'description', content: 'Discover the most popular celebrities on Nmovies.' },
  {
    name: 'keywords',
    content:
  ...
  { property: 'og:title', content: 'Nmovies - Popular People' },
  { property: 'og:image', content: 'https://sorachill.vercel.app/api/ogimage?it=people' },
  { property: 'og:description', content: 'Discover the most popular celebrities on Nmovies.' },
  { name: 'twitter:title', content: 'Nmovies - Popular People' },
  { name: 'twitter:description', content: 'Discover the most popular celebrities on Nmovies.' },
