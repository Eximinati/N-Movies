...
export const meta = mergeMeta(({ params }) => {
  ...
  return [
    { title: `Nmovies - Trending ${mediaType} today` },
    {
      name: 'keywords',
    ...
    { property: 'og:title', content: `Nmovies - Trending ${mediaType} today` },
    { name: 'description', content: `Trending ${mediaType} today` },
    { property: 'og:description', content: `Trending ${mediaType} today` },
    { name: 'twitter:title', content: `Nmovies - Trending ${mediaType} today` },
