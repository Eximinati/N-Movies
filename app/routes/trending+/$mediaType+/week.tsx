...
export const meta = mergeMeta(({ params }) => {
  ...
  return [
    { title: `Nmovies - Trending ${mediaType} This Week` },
    {
      name: 'keywords',
    ...
    { property: 'og:title', content: `Nmovies - Trending ${mediaType} This Week` },
    { name: 'description', content: `Trending ${mediaType} This Week` },
    { property: 'og:description', content: `Trending ${mediaType} This Week` },
    { name: 'twitter:title', content: `Nmovies - Trending ${mediaType} This Week` },
