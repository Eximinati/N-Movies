...
export const meta = mergeMeta(() => [
  { title: 'Nmovies - Discover tv shows' },
  { name: 'description', content: 'Discover tv shows on Nmovies' },
  { property: 'og:url', content: 'https://sorachill.vercel.app/discover/tv-shows' },
  { property: 'og:title', content: 'Nmovies - Discover tv shows' },
  { property: 'og:image', content: 'https://sorachill.vercel.app/api/ogimage?it=tvshows' },
  { property: 'og:description', content: 'Discover tv shows on Nmovies' },
  { name: 'twitter:title', content: 'Nmovies - Discover tv shows' },
  { name: 'twitter:description', content: 'Discover tv shows on Nmovies' },
