...
export const meta = mergeMeta(() => [
  { title: 'Nmovies - Discover anime' },
  { name: 'description', content: 'Discover Anime on Nmovies' },
  { property: 'og:url', content: 'https://sorachill.vercel.app/discover/anime' },
  { property: 'og:title', content: 'Nmovies - Discover anime' },
  { property: 'og:image', content: 'https://sorachill.vercel.app/api/ogimage?it=anime' },
  { property: 'og:description', content: 'Discover Anime on Nmovies' },
  { name: 'twitter:title', content: 'Nmovies - Discover anime' },
  { name: 'twitter:description', content: 'Discover Anime on Nmovies' },
