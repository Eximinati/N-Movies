...
export const meta = mergeMeta(() => [
  { title: 'Nmovies - Discover movies' },
  { name: 'description', content: 'Discover Movies on Nmovies' },
  { property: 'og:url', content: 'https://sorachill.vercel.app/discover/movies' },
  { property: 'og:title', content: 'Nmovies - Discover movies' },
  { property: 'og:image', content: 'https://sorachill.vercel.app/api/ogimage?it=movies' },
  { property: 'og:description', content: 'Discover Movies on Nmovies' },
  { name: 'twitter:title', content: 'Nmovies - Discover movies' },
  { name: 'twitter:description', content: 'Discover Movies on Nmovies' },
