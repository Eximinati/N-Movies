...
export const meta = mergeMeta(() => [
  { title: 'Nmovies - Movies' },
  { name: 'description', content: 'Discover movies in Nmovies' },
  { property: 'og:url', content: 'https://sorachill.vercel.app/movies/' },
  { property: 'og:title', content: 'Nmovies - Movies' },
  { property: 'og:description', content: 'Discover movies in Nmovies' },
  { name: 'twitter:title', content: 'Nmovies - Movies' },
  { name: 'twitter:description', content: 'Discover movies in Nmovies' },
]);
