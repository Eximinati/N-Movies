...
export const meta = mergeMeta(() => [
  { title: 'Nmovies - Anime' },
  { name: 'description', content: 'Discover anime in Nmovies' },
  { property: 'og:url', content: 'https://sorachill.vercel.app/anime' },
  { property: 'og:title', content: 'Nmovies - Anime' },
  { property: 'og:description', content: 'Discover anime in Nmovies' },
  { name: 'twitter:title', content: 'Nmovies - Anime' },
  { name: 'twitter:description', content: 'Discover anime in Nmovies' },
]);
