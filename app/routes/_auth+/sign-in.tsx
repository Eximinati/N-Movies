...
export const meta = mergeMeta(() => [
  { title: 'Nmovies - Sign In' },
  { name: 'description', content: 'Sign in to your Nmovies account.' },
  { property: 'og:title', content: 'Nmovies - Sign In' },
  { property: 'og:description', content: 'Sign in to your Nmovies account.' },
  { property: 'og:url', content: 'https://sorachill.vercel.app/sign-in' },
  { property: 'twitter:title', content: 'Nmovies - Sign In' },
  { property: 'twitter:description', content: 'Sign in to your Nmovies account.' },
]);
