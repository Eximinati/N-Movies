...
export const meta = mergeMeta(() => [
  { title: 'Nmovies - Sign Up' },
  { name: 'description', content: 'Sign up for a Nmovies account.' },
  { property: 'og:title', content: 'Nmovies - Sign Up' },
  { property: 'og:description', content: 'Sign up for a Nmovies account.' },
  { property: 'og:url', content: 'https://sorachill.vercel.app/sign-up' },
  { property: 'twitter:title', content: 'Nmovies - Sign Up' },
  { property: 'twitter:description', content: 'Sign up for a Nmovies account.' },
]);
