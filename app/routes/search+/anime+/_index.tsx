...
export const meta = mergeMeta(() => [
  { title: 'Nmovies - Search Anime' },
  { name: 'description', content: 'Search Anime on Nmovies' },
  { property: 'og:url', content: 'https://sorachill.vercel.app/search/anime/' },
  { property: 'og:title', content: 'Nmovies - Search Anime' },
  { property: 'og:description', content: 'Search Anime on Nmovies' },
  { name: 'twitter:title', content: 'Nmovies - Search Anime' },
  { name: 'twitter:description', content: 'Search Anime on Nmovies' },
]);
