...
export const meta = mergeMeta(() => [
  { title: 'Nmovies - Search Movies' },
  { name: 'description', content: 'Search Movies on Nmovies' },
  {
    property: 'og:url',
    content: 'https://sorachill.vercel.app/search/movie/ ',
  },
  { property: 'og:title', content: 'Nmovies - Search Movies' },
  { property: 'og:description', content: 'Search Movies on Nmovies' },
  { name: 'twitter:title', content: 'Nmovies - Search Movies' },
  { name: 'twitter:description', content: 'Search Movies on Nmovies' },
]);
