...
export const meta = mergeMeta(({ data, params }) => {
  ...
  return [
    { title: `Nmovies - Search results for ${params.movieKeyword}` },
    {
      name: 'keywords',
    ...
    { property: 'og:title', content: `Nmovies - Search results for ${params.movieKeyword}` },
    {
      property: 'og:image',
    ...
    { name: 'twitter:title', content: `Nmovies - Search results for ${params.movieKeyword}` },
  ];
});
