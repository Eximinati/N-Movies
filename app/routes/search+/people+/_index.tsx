...
export const meta = mergeMeta(() => [
  { title: 'Nmovies - Search People' },
  { name: 'description', content: 'Search People on Nmovies' },
  { property: 'og:url', content: 'https://sorachill.vercel.app/search/people/' },
  { property: 'og:title', content: 'Nmovies - Search People' },
  { property: 'og:description', content: 'Search People on Nmovies' },
  { name: 'twitter:title', content: 'Nmovies - Search People' },
  { name: 'twitter:description', content: 'Search People on Nmovies' },
]);
