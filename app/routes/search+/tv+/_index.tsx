...
export const meta = mergeMeta(() => [
  { title: 'Nmovies - Search Tv Shows' },
  { name: 'description', content: 'Search Tv Shows on Nmovies' },
  { property: 'og:url', content: 'https://sorachill.vercel.app/search/tv/' },
  { property: 'og:title', content: 'Nmovies - Search Tv Shows' },
  { property: 'og:description', content: 'Search Tv Shows on Nmovies' },
  { name: 'twitter:title', content: 'Nmovies - Search Tv Shows' },
  { name: 'twitter:description', content: 'Search Tv Shows on Nmovies' },
]);
