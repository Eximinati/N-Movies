...
export const meta = mergeMeta(() => [
  { title: 'Nmovies - Tv Shows' },
  { name: 'description', content: 'Discover tv shows in Nmovies' },
  { property: 'og:url', content: 'https://sorachill.vercel.app/tv-shows/' },
  { property: 'og:title', content: 'Nmovies - Tv Shows' },
  { property: 'og:description', content: 'Discover tv shows in Sora' },
  { name: 'twitter:title', content: 'Nmovies - Tv Shows' },
  { name: 'twitter:description', content: 'Discover tv shows in Nmovies' },
]);
