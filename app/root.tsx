  ...
  React.useEffect(() => {
    if (isUpdateAvailable) {
      toast.success('Update Available', {
        description: 'A new version of Nmovies is available.',
        action: {
          label: 'Update',
          onClick: () => reloadPage(),
        },
